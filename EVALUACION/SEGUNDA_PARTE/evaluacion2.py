...
class Particular(Automovil):
    ...
    def __str__(self):
        return f'{super().__str__()}, Velocidad: {self.velocidad} Km/h, Cilindrada: {self.cilindrada} cc, Numeros puestos {self.numero_puestos}'
...
class Carga(Automovil):
    ...
    def __str__(self):
        return f'{super().__str__()}, Velocidad: {self.velocidad} Km/h, Cilindrada: {self.cilindrada} cc, Peso de carga {self.peso_carga}'
